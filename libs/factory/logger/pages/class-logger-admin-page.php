 ...
 * @version       1.0
 */
class Wbcr_FactoryLogger100_AdminPage extends Wbcr_FactoryPages436_AdminPage {
	...
	public function __construct( $plugin ) {
		...
		$this->page_title  = __( 'Plugin log', 'wbcr_factory_logger_100' );
	...
	public function showPageContent() {
        ...
        <div class="wbcr_factory_logger_container">
            <div class="wbcr_factory_logger_page_title">
                <h1><?php _e( 'Logs of the', 'wbcr_factory_logger_100' ) ?>
