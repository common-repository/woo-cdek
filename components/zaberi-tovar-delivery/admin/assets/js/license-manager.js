...
jQuery(function($) {
	...
	$(document).on('click', '.wdzt-control-btn', function() {
		var wrapper = $('#wdzt-license-wrapper'),
		...
		$('.wdzt-control-btn').hide();

		$(this).after('<img class="wdzt-loader" src="' + loader + '">');

		var data = {
			action: 'wdzt_check_license',
			_wpnonce: wpnonce,
