 ...
 *
 */
function wdzt_check_license() {
	check_admin_referer( "wdzt_license_activate" );

	$plugin_instance = WBCR\Delivery\ZaberiTovar\Plugin::app();
...
add_action( 'wp_ajax_wdzt_check_license', 'wdzt_check_license' );
