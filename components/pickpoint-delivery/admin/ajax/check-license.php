 ...
 *
 */
function wdyd_check_license() {
	check_admin_referer( "wdyd_license_activate" );

	$plugin_instance = WPickpoint\Plugin::app();
...
add_action( 'wp_ajax_wdyd_check_license', 'wdyd_check_license' );