...
jQuery(function($) {
    ...
    $(document).on('click', '.wdpk-control-btn', function() {
        var wrapper = $('#wdpk-license-wrapper'),
        ...
        $('.wdpk-control-btn').hide();

        $(this).after('<img class="wdpk-loader" src="' + loader + '">');

        var data = {
            action: 'wdpk_check_license',
            _wpnonce: wpnonce,
