 ...
 *
 */
function wdpk_check_license() {
    check_admin_referer( "wdpk_license_activate" );

    $plugin_instance = WDPK\Delivery\Peshkariki\Plugin::app();
...
add_action( 'wp_ajax_wdpk_check_license', 'wdpk_check_license' );
