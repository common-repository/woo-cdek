...
function ISDEKWidjet(params) {
    ...
    widjet.hideLoader = function () {
        if (!widjet.loaderHided) {
            ...
            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search, .CDEK-widget__sidebar, .CDEK-widget__logo').removeClass('CDEK-widget__inaccessible');
        }
    };
    ...
    var template = {
        ...
        html: {
            ...
            makeADAPT: function () {
                ...
                var moduleH = ipjq(IDS.get('advanced_widget_cnt')).outerHeight();
                if (moduleH < 476) {

                } else {
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list__box, .mCustomScrollBox').css('max-height', 'auto');
                }

                if (moduleH < ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__box').outerHeight() + 56) {
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type').css('max-height', (moduleH - 56) + 'px');
                } else {
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type').css('max-height', ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__box').outerHeight() + 'px');
                }
            },
            ...
            place: function () {
                ...
                if (!widjet.options.get('choose')) {
                    ipjq(IDS.get('advanced_widget_cnt')).addClass('nochoose');
                }
                ...
                if (widjet.options.get('hidedelt')) {
                    ipjq(IDS.get('advanced_delivery_types')).hide();
                }
            ...
            updatePrices: function (obPrices) {
                ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_types') + " div.CDEK-widget__delivery-type__item").remove();

                if (typeof obPrices == 'undefined' || obPrices.length == 0) {
                    ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_type_title span.CDEK_choose')).hide();
                    ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_type_title span.CDEK_no-avail')).show();
                    ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_type_none')).show();
                } else {
                    ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_type_title span.CDEK_choose')).show();
                    ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_type_title span.CDEK_no-avail')).hide();
                    ipjq(IDS.get('advanced_widget_cnt')).find(IDS.get('advanced_delivery_type_none')).hide();
                        ...
                        switch (i) {
                            ...
                            case 'pickup':
                                if (!CALCULATION.bad || obPrices[i].price !== false) {
                                    ...
                                    ipjq(IDS.get('advanced_delivery_types')).append(_tmpBlock);
                                }
                        }
                    }
            ...
            hideMap: function () {
                ...
                ipjq(IDS.get('advanced_widget_cnt')).find('#SDEK_info').css('display', 'none');
            },
        },
        ...
        controller: {
            ...
            loadCity: function (doLoad) {
                ...
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-details__back').click();
            ...
            selectCity: function (city) {
                ...
                if (typeof city === 'undefined' || !city) {
                    city = ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul li').not('.no-active').first().data('cityid');
                }

                DATA.city.set(city);
                template.controller.loadCity();

                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-box input[type=text]').val(DATA.city.getName(city));
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul li').removeClass('focus').addClass('no-active').parent('ul').removeClass('open');
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-box input[type=text]')[0].blur();
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__button').attr('class', 'CDEK-widget__delivery-type__button');
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__item').removeClass('active');
                setTimeout(function () {
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type').removeClass('CDEK-widget__delivery-type_close');
                }, 1000);
            ...
            chooseDeliveryType: function () {
                ...
                if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul').hasClass('open')) {
                    var $liFocus = ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul').find('li.focus');
                    if ($liFocus.length != 0) {
            ...
            choosePVZ: function (id) {
                var qq = ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__item:last');
                if (!qq.hasClass('active')) {
                    qq.attr('class', 'CDEK-widget__delivery-type__item').addClass('active');
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__item:first').attr('class', 'CDEK-widget__delivery-type__item').removeClass('active');
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__button').attr('class', 'CDEK-widget__delivery-type__button').addClass('CDEK-widget__delivery-type__button_pvz');
                }
        ...
        ui: {
            ...
            addressSearch: {
                ...
                getInput: function () {
                    return ipjq(IDS.get('advanced_courier_address_place'));
                },
                ...
                show: function () {
                    ...
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__courier-address__box').removeClass('CDEK-widget__courier-address__box_close');
                },

                hide: function () {
                    template.ui.addressSearch.active = false;
                    template.ui.addressSearch.killBaloon();
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__courier-address__box').addClass('CDEK-widget__courier-address__box_close');
                },
                ...
                fill: function () {
                    ...
                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__courier-address__button').addClass('allowed');
                },
                ...
                makeBaloon: function (coords, text) {
                    ...
                    if (template.ui.addressSearch.baloon) {
                        ...
                        window.setTimeout(function () {
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__baloon .CDEK-widget__choose').on('click', template.ui.addressSearch.clickBaloon);
                        }, 500);
                    }
                },
                        ...
                        function (data) {
                            if (typeof (data.error) === 'undefined') {
                                if (DATA.city.get() == data.city.id) {
                                    ...
                                    ipjq(IDS.get('advanced_search_input')).val(data.city.city);
                                    template.html.updatePrices({
            ...
            open: function () {
                ...
                this.active = true;
                if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list__box li').length >= 10) {
                    ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__search-list__box").mCustomScrollbar();
                }
            },
        ...
        ymaps: {
            ...
            init: function (city) {
                ...
                if (city == false) {
                    ymaps.geolocation.get({}).then(function (result) {
                        ...
                        ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-box input[type=text]').val(city);
            ...
            loadMap: function (city) {
                ...
                let mtypes = {};
                if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__sidebar-button-point.active').length) {

                    ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__sidebar-button-point.active').each(function () {
            ...
            makeMap: function (addInfo) {
                ...
                if (widjet.options.get('detailAddress')) {
                    ...
                    var suggestView1 = new ymaps.SuggestView(IDS.get('advanced_courier_address_place').substr(1));
                }
            },
            ...
            placeMarks: function (mtypes) {
                ...
                if (typeof pvzList === 'object') {
                    ...
                    for (var i in pvzList) {
                        ...
                        pvzList[i].placeMark.events.add(['balloonopen', 'click'], function (metka) {
                            ...
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__sidebar-burger:not(.active)').trigger('click');
                            template.ui.markChozenPVZ({data: {id: metka.get('target').link, link: template.ui}});
                        });

                        pvzList[i].placeMark.events.add(['mouseenter'], function (metka) {
                            ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__panel-content").mCustomScrollbar("scrollTo", metka.get('target').listItem);
                ...
                ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__panel-content").mCustomScrollbar();
                ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__delivery-type").mCustomScrollbar();
                if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list__box li').length >= 10) {
                    ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__search-list__box").mCustomScrollbar();
                }
            ...
            makeUpCenter: function (cords) {
                ...
                if (ipjq(IDS.get('advanced_widget_cnt')).width() - ww > 100) {
            ...
            selectMark: function (wat) {
                ...
                ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__panel-list").css('left', '-330px');
                ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__panel-details").css('right', '0px');
            },
    ...
    widjet.sdekWidgetEvents = function () {
        ...
        ipjq(IDS.get('advanced_widget_cnt')).on('click', '.CDEK-widget__sidebar-button', {widjet: widjet}, function () {

            _this = ipjq(this);
            _this.toggleClass('active');
            var idHint = _this.attr('data-hint');
            var wid = ipjq(IDS.get('advanced_widget_cnt')).find(idHint).outerWidth();
            ...
            if (_this.hasClass('CDEK-widget__sidebar-button-point')) {
                ...
                ipjq(IDS.get('advanced_widget_cnt')).find(idHint).css({
                    right: -wid,
                    'opacity': '0'
                });
                ...
                if (_this.hasClass('CDEK-widget__sidebar-burger')) {
                    ...
                    if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel').hasClass('open')) {
                        if (_this.hasClass('active')) {
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-contacts').fadeOut(600);
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-list, .CDEK-widget__panel-details').fadeIn(600);
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__sidebar-button_phone').removeClass('active');
                        } else {
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-list, .CDEK-widget__panel-details').fadeOut(600);
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel').removeClass('open');
                        }
                    } else {
                        ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel').addClass('open');
                        ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-list, .CDEK-widget__panel-details').fadeIn(600);
                    }
                }
                ...
                if (_this.hasClass('CDEK-widget__sidebar-button_phone')) {
                    if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel').hasClass('open')) {
                        if (_this.hasClass('active')) {
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-list, .CDEK-widget__panel-details').fadeOut(600);
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-contacts').fadeIn(600);
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__sidebar-burger').removeClass('active').removeClass('open').addClass('close');
                        } else {
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel-contacts').fadeOut(600);
                            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel').removeClass('open');
                        }
        ...
        ipjq(IDS.get('advanced_widget_cnt')).on('mousemove', '.CDEK-widget__sidebar-button', function () {
            if (!ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__panel').hasClass('open')) {
        ...
        ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__sidebar-button').each(function (index, el) {
            var idHint = ipjq(el).attr('data-hint');
            var top = (ipjq(el).outerHeight() + -ipjq(IDS.get('advanced_widget_cnt')).find(idHint).outerHeight()) / 2 + 62 * index;
            var wid = ipjq(IDS.get('advanced_widget_cnt')).find(idHint).outerWidth();
            ipjq(IDS.get('advanced_widget_cnt')).find(idHint).css({
                'right': -wid,
                'top': top,
        ...
        ipjq(IDS.get('advanced_widget_cnt'))
            .on('click', '.CDEK-widget__panel-details__back', function () {
                ipjq(this).parents('.CDEK-widget__panel-details').css('right', '-330px');
                ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__panel-list").css('left', '0px');
            }).on('click', '.CDEK-widget__panel-details__block-img', function () {
            var src = ipjq(this).find('img').attr('src');
            var $block = ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__photo');
            $block.find('img').attr('src', src);
            $block.addClass('active');
        }).on('click', '.CDEK-widget__photo', function (e) {
            if (!ipjq(e.target).is('img')) {
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__photo').removeClass('active');
            }
        }).on('focusin', '.CDEK-widget__search-box input[type=text]', function () {
            ipjq(this).val('');
            if (ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type').hasClass('CDEK-widget__delivery-type_close')) {
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul').addClass('open')
                    .find('li').removeClass('no-active');
                return
            }
            ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type').addClass('CDEK-widget__delivery-type_close');
            setTimeout(function () {
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul').addClass('open')
                    .find('li').removeClass('no-active');
            }, 1000);
            ...
            var $liActive = ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul li:not(.no-active)');
            var $liFocus = $liActive.filter('.focus');
            if (e.keyCode === 40) {
                if ($liFocus.length == 0) {
                    $liActive.first().addClass('focus');
                    ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__search-list__box").mCustomScrollbar('scrollTo', $liActive.first(), {
                        scrollInertia: 300
                    });
                } else {
                    ...
                    if ($liFocus.nextAll().filter(':not(.no-active)').eq(0).length != 0) {
                        ...
                        ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__search-list__box").mCustomScrollbar('scrollTo', $liFocus.next($liActive), {
                            scrollInertia: 300
                        });
                    } else {
                        $liActive.first().addClass('focus');
            ...
            if (e.keyCode === 38) {
                if ($liFocus.length == 0) {
                    ...
                    ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__search-list__box").mCustomScrollbar('scrollTo', $liActive.last(), {
                        scrollInertia: 300
                    });
                } else {
                    $liFocus.removeClass('focus');
                    if ($liFocus.prevAll().filter(':not(.no-active)').eq(0).length != 0) {
                        ...
                        ipjq(IDS.get('advanced_widget_cnt')).find(".CDEK-widget__search-list__box").mCustomScrollbar('scrollTo', $liFocus.prev($liActive), {
                            scrollInertia: 300
                        });
                    } else {
                        $liActive.last().addClass('focus');
            ...
            var $li = ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul li');
            ...
            if (ipjq(e.target).closest('.CDEK-widget__search').length == 0 && ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-list ul li').not('.no-active').length != 0) {
                template.controller.putCity(template.controller.getCity());
            }
        }).on('click', '.CDEK-widget__delivery-type__item', {widjet: widjet}, function (e) {
            var type = ipjq(this).attr('data-delivery-type');
            if (!ipjq(this).hasClass('active')) {
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__item.active').removeClass('active');
                ipjq(this).addClass('active');
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__delivery-type__button').attr('class', 'CDEK-widget__delivery-type__button').addClass('CDEK-widget__delivery-type__button_' + type);
            }
            if (type == 'courier') {
    ...
    widjet.city = {
        ...
        set: function (name) {
            ...
            if (newCity !== false) {
                ipjq(IDS.get('advanced_widget_cnt')).find('.CDEK-widget__search-box input[type=text]').val(DATA.city.getName(newCity));
            }
            template.controller.loadCity();
        },
        check: function (name) {
