...
class Condition {
	 ...
	 * @since 1.0.0
	 */
	public function __construct( $id = 0, $group = 0, $condition = null, $operator = null, $value = null ) {
		$this->id        = $id;
		$this->group     = $group;
		$this->condition = $condition ? $condition : 'subtotal';
	...
	public function output_condition_row() {
		$wp_condition = $this;
		require WDAD_ADVANCED_DIR . "/views/html-condition-row.php";
	}
	...
	public function get_conditions() {
		...
		$conditions = apply_filters( 'wdad_advanced_conditions', $conditions );
	...
	public function get_operators() {
		...
		$operators = apply_filters( 'wdad_advanced_operators', $operators );
	...
	public function get_value_field_args() {
		...
		switch ( $this->condition ) :
			...
			case 'contains_product' :
				...
				if ( $product = wc_get_product( $this->value ) ) {
					$values['options'][ $this->value ]            = $product->get_formatted_name();
				}
		...
		$values = apply_filters( 'wdad_advanced_values', $values, $this->condition, $this );
	...
	public function get_description() {
		...
		$descriptions = apply_filters( 'wdad_advanced_shipping_conditions_descriptions', $descriptions );
