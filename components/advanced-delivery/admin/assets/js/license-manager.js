...
jQuery(function ($) {
    ...
    $(document).on('click', '.wdad-control-btn', function () {
        var wrapper = $('#wdad-license-wrapper'),
        ...
        $('.wdad-control-btn').hide();

        $(this).after('<img class="wdad-loader" src="' + loader + '">');

        var data = {
            action: 'wdad_check_license',
            _wpnonce: wpnonce,
