 ...
 *
 */
function wdad_check_license() {
	check_admin_referer( "wdad_license_activate" );

	$plugin_instance = WBCR\Delivery\Cdek\Plugin::app();
...
add_action( 'wp_ajax_wdad_check_license', 'wdad_check_license' );