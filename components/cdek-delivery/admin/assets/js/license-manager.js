...
jQuery(function ($) {
    ...
    $(document).on('click', '.wdcd-control-btn', function () {
        var wrapper = $('#wdcd-license-wrapper'),
        ...
        $('.wdcd-control-btn').hide();

        $(this).after('<img class="wdcd-loader" src="' + loader + '">');

        var data = {
            action: 'wdcd_check_license',
            _wpnonce: wpnonce,
